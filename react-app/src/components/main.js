...
class Main extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.arrOfBeasts = hornedBeast.map(entity => {return entity});
        console.log(this.arrOfBeasts);
        this.state = {
            title: this.arrOfBeasts.title,
            image_url: this.arrOfBeasts.image_url,
            description: this.arrOfBeasts.description
    ...
    render() {
        ...
        return (
            <div>
                <HornedBeast title={this.state.title}
